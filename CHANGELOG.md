...
## Halo 1.1.2 (19-02-2024)
- Fixed minor bugs.

## Halo 1.1.1 (20-10-2023)
- Fixed minor bugs.

## Halo 1.1.0 (13-10-2023)
- Remove data_tag_enabled check from everywhere.
- Update Payment.
- Update Ask An Expert Form.
- Update Code Settings.
- Fixed minor bugs.

## Halo 1.0.9 (20-07-2023)
- Bump Stencil utils to 6.15.0

## Halo 1.0.8 (16-06-2023)
- Update contact with author

## Halo 1.0.7 (21-05-2023)
- Added new Home - Yoga.

## Halo 1.0.6 (06-03-2023)
- Update CSS code in Checkout page.
- Fixed when clicking on the size chart button, the close button is not displayed.
- Update Ask an expert Form.
- Fixed Blog Page does not show pagination.
- Fixed when clicking Next/Prev review does not lead to the review tab.

## Halo 1.0.5 (26-12-2022)
- Update Code Preload/Early Hints.
- Update micro data schema.
- Update Code Page Builder.
- Fixed minor bugs.

## Halo 1.0.4 (08-09-2022)
- Fixed side cart not showing when adding product to cart.
- Updated Editor for theme.
- Updated Sticky Add To cart for theme.
- Updated Quick Search for theme.
- Fixed Cart Page (Cart page was requested twice)
- Fixed minor bugs.
- Updated small CSS.

## Halo 1.0.4 (02-09-2022)
- Added new Home - Animals and Pet.

## Halo 1.0.3 (14-07-2022)
- Fixed Quick View Bug from Bigcommerce.

## Halo 1.0.2 (26-04-2022)
- Fixed mega menu not working when going to Theme Styles -> Menu -> Menu Settings -> Edit MegaMenu and select "Theme Source".

## Halo 1.0.1 (28-01-2022)
- Added new Home - Comestic
- Updated Recommended For You and Customers Who Bought This Item Also Bought blocks using New Products or Featured Products or Top Sellers Products.
- Updated Recently Viewed and Next Previous Product functions using GraphQL.

## Halo 1.0.0 (21-01-2022)
