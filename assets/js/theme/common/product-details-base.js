...
export default class ProductDetailsBase {
    ...
    getViewModel($scope) {
        return {
            ...
            $kitAddToCart: $('#self-kit-addtocart', $scope),
    ...
    updateView(data, content = null) {
        const $thisScope = this.$scope.find('.productView-options');
        ...
        const productWishList = $('[data-wishlist-add]');
        const shareLinkSocial = $('.productView-options .shareLinkSocial');

        if (addToCartWrapper.is(':hidden') && data.purchasable) {
            addToCartWrapper.show();
            productWishList.removeClass('product-outOfStock');
            shareLinkSocial.removeClass('product-outOfStock');
        }
        else {
            productWishList.addClass('product-outOfStock');
            shareLinkSocial.removeClass('product-outOfStock');
        }
    }
